...
import { useProducts } from '@/providers/productsProvider'; // ✅ Correct hook
...
const Header = () => {
    ...
    return (
        <header className="bg-white py-4 px-6 border-b sticky top-0 z-30">
            <div className="max-w-7xl mx-auto">
                <div className="flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        <SearchProducts products={products} /> {/* ✅ Working now */}
